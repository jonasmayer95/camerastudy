...
public class KinectManager : MonoBehaviour
{
    ...
    void StartKinect()
    {
        ...
        bodyFrame = new KinectInterop.BodyFrameData(sensorData.bodyCount, KinectInterop.Constants.JointCount);
        ...
        recorder = GetComponent<KinectRecorder>();
    ...
    private void ProcessBodyFrameData(ref KinectInterop.BodyFrameData bodyFrame)
    {
